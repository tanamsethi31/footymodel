...
- [ ] **R052** — Batch of 5 dashboard asks: scope + sequencing → *large*
  ...
  - [ ] Trivial items first (equal-width tabs, remove em dashes), then rebrand (#5), then glossary page (#3) and expandable match detail (#4) styled to match the new brand (Recommended)
